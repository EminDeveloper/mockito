package com.mockito.mockito.infrastructure.configuration.persistence;
...
@EnableJpaRepositories(basePackages = "com.mockito.mockito.infrastructure.database.repository")
